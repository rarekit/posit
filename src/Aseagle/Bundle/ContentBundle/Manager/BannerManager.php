 ...
 */
class BannerManager implements ObjectManagerInterface {
    /**
    ...
    public function getRepository() {
        return $this->entityManager->getRepository('AseagleContentBundle:Banner');
    }
    ...
    public function createObject() {
        return new \Aseagle\Bundle\ContentBundle\Entity\Banner();
    }
