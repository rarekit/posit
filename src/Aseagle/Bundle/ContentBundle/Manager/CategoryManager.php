 ...
 */
class CategoryManager implements ObjectManagerInterface {
    /**
    ...
    public function getRepository() {
        return $this->entityManager->getRepository('AseagleContentBundle:Category');
    }
    ...
    public function createObject() {
        return new \Aseagle\Bundle\ContentBundle\Entity\Category();
    }
