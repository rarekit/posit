 ...
 */
class SettingManager implements ObjectManagerInterface {
    /**
    ...
    public function getRepository() {
        return $this->entityManager->getRepository('AseagleContentBundle:Setting');
    }
    ...
    public function createObject() {
        return new \Aseagle\Bundle\ContentBundle\Entity\Setting();
    }
