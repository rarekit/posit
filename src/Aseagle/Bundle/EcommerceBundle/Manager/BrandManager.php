 ...
 */
class BrandManager implements ObjectManagerInterface {
    /**
    ...
    public function getRepository() {
        return $this->entityManager->getRepository('AseagleEcommerceBundle:Brand');
    }
    ...
    public function createObject() {
        return new \Aseagle\Bundle\EcommerceBundle\Entity\Brand();
    }
