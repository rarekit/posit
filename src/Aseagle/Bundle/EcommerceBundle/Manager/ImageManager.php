 ...
 */
class ImageManager implements ObjectManagerInterface {
    /**
    ...
    public function getRepository() {
        return $this->entityManager->getRepository('AseagleEcommerceBundle:Image');
    }
    ...
    public function createObject() {
        return new \Aseagle\Bundle\EcommerceBundle\Entity\Image();
    }
