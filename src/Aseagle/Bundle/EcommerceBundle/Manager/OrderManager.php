 ...
 */
class OrderManager implements ObjectManagerInterface {
    /**
    ...
    public function getRepository() {
        return $this->entityManager->getRepository('AseagleEcommerceBundle:Order');
    }
    ...
    public function createObject() {
        return new \Aseagle\Bundle\EcommerceBundle\Entity\Order();
    }
