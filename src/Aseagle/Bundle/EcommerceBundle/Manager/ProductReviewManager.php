 ...
 */
class ProductReviewManager implements ObjectManagerInterface {
    /**
    ...
    public function getRepository() {
        return $this->entityManager->getRepository('AseagleEcommerceBundle:ProductReview');
    }
    ...
    public function createObject() {
        return new \Aseagle\Bundle\EcommerceBundle\Entity\ProductReview();
    }
