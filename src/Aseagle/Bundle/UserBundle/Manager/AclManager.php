 ...
 */
class AclManager implements ObjectManagerInterface {
    /**
    ...
    public function getRepository() {
        return $this->entityManager->getRepository('AseagleUserBundle:Acl');
    }
    ...
    public function createObject() {
        return new \Aseagle\Bundle\UserBundle\Entity\Acl();
    }
