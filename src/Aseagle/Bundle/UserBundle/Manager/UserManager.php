 ...
 */
class UserManager implements ObjectManagerInterface {
    /**
    ...
    public function getRepository() {
        return $this->entityManager->getRepository('AseagleUserBundle:User');
    }
    ...
    public function createObject() {
        return new \Aseagle\Bundle\UserBundle\Entity\User();
    }
